...
class SolutionBfs {
    public int solution(int[] queue1, int[] queue2) {
        ...
        Set<Queue<Integer>> q1Set = new HashSet<>();
        Set<Queue<Integer>> q2Set = new HashSet<>();
            ...
            if ((!now.q1.isEmpty() || !now.q2.isEmpty())) {
                ...
                if (!newQ1_1.isEmpty() && !newQ2_1.isEmpty()) {
                    ...
                    if (!newQ1_1.equals(q1) && !newQ2_1.equals(q2)
                            && !q1Set.contains(newQ1_1) && !q2Set.contains(newQ2_1)) {
                        q1Set.add(newQ1_1);
                        q2Set.add(newQ2_1);
                ...
                if (!newQ1_2.isEmpty() && !newQ2_2.isEmpty()) {
                    ...
                    if (!newQ1_2.equals(q1) && !newQ2_2.equals(q2)
                            && !q1Set.contains(newQ1_2) && !q2Set.contains(newQ2_2)) {
                        q1Set.add(newQ1_2);
                        q2Set.add(newQ2_2);
...
public class SumSameQueueBfsFail {
